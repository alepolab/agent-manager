...
export const workflowTemplates: WorkflowTemplate[] = [
  ...
  },
  {
    ...
    description: 'Scans a repository for security vulnerabilities (OWASP, CVEs, secrets, injection), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    icon: 'i-lucide-shield-alert',
    parameters: [{ name: 'projectDir', description: 'The repository checkout to scan. Leave it blank on a run started by a sweep: that child works in its own workspace and clones the repo named by `repo`.' }, { name: 'repo', description: 'The repository this run was started for, as scan-registry.yaml names it (owner/name). Set by a sweep fanning out over repositories; leave blank when you are pointing the run at a checkout yourself.' }, { name: 'branch', description: 'The branch to scan. Leave it blank for the product\'s development branch from the registry (branches.bug, usually develop). The run reads it in a worktree of its own, never the shared clone.' }],
    steps: [
      ...
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the security scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
  ...
  },
  {
    ...
    description: 'Scans a repository for functional bugs (static analysis, build warnings, test failures, logic errors), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    icon: 'i-lucide-bug',
    parameters: [{ name: 'projectDir', description: 'The repository checkout to scan. Leave it blank on a run started by a sweep: that child works in its own workspace and clones the repo named by `repo`.' }, { name: 'repo', description: 'The repository this run was started for, as scan-registry.yaml names it (owner/name). Set by a sweep fanning out over repositories; leave blank when you are pointing the run at a checkout yourself.' }, { name: 'branch', description: 'The branch to scan. Leave it blank for the product\'s development branch from the registry (branches.bug, usually develop). The run reads it in a worktree of its own, never the shared clone.' }],
    steps: [
      ...
      { agentTemplateId: 'sdlc-decision-gate', id: 'decision-gate', label: 'Decision Gate', next: ['create-jira-auto-approved', 'tell-reviewers'], monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-auto-approved', label: 'Create Jira (Auto-Approved)', next: ['dispatch-auto-approved-to-runbook-a-b'], jira: { action: 'create', source: 'approved-drafts.json' }, runWhen: { artifact: 'approved-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the functional scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-auto-approved-to-runbook-a-b', label: 'Dispatch Auto-Approved to Runbook A/B', next: [], runWhen: { artifact: 'approved-drafts.json' }, triggerWorkflow: { source: 'approved-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-escalated-to-runbook-a-b', label: 'Dispatch Escalated to Runbook A/B', next: [], runWhen: { artifact: 'escalated-drafts.json' }, triggerWorkflow: { source: 'escalated-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
    ],
  },
  {
    ...
    description: 'Scans a repository for technical debt (anti-patterns, dead code, duplication, deferred work markers, dependency hygiene), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    ...
    steps: [
      ...
      { agentTemplateId: 'sdlc-decision-gate', id: 'decision-gate', label: 'Decision Gate', next: ['create-jira-auto-approved', 'tell-reviewers'], monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-auto-approved', label: 'Create Jira (Auto-Approved)', next: ['dispatch-auto-approved-to-runbook-a-b'], jira: { action: 'create', source: 'approved-drafts.json' }, runWhen: { artifact: 'approved-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the tech debt scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-auto-approved-to-runbook-a-b', label: 'Dispatch Auto-Approved to Runbook A/B', next: [], runWhen: { artifact: 'approved-drafts.json' }, triggerWorkflow: { source: 'approved-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-escalated-to-runbook-a-b', label: 'Dispatch Escalated to Runbook A/B', next: [], runWhen: { artifact: 'escalated-drafts.json' }, triggerWorkflow: { source: 'escalated-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
    ],
  },
  {
    ...
    description: 'Scans a repository for test coverage gaps (missing unit tests, low coverage files, skipped tests, test quality issues), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    ...
    steps: [
      ...
      { agentTemplateId: 'sdlc-decision-gate', id: 'decision-gate', label: 'Decision Gate', next: ['create-jira-auto-approved', 'tell-reviewers'], monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-auto-approved', label: 'Create Jira (Auto-Approved)', next: ['dispatch-auto-approved-to-runbook-a-b'], jira: { action: 'create', source: 'approved-drafts.json' }, runWhen: { artifact: 'approved-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the test gaps scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-auto-approved-to-runbook-a-b', label: 'Dispatch Auto-Approved to Runbook A/B', next: [], runWhen: { artifact: 'approved-drafts.json' }, triggerWorkflow: { source: 'approved-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-escalated-to-runbook-a-b', label: 'Dispatch Escalated to Runbook A/B', next: [], runWhen: { artifact: 'escalated-drafts.json' }, triggerWorkflow: { source: 'escalated-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
    ],
  },
  {
    ...
    description: 'Scans a repository for missing end-to-end test scenarios (user flows, API integration points, error scenarios, cross-browser coverage), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    icon: 'i-lucide-route',
    parameters: [{ name: 'projectDir', description: 'The repository checkout to scan. Leave it blank on a run started by a sweep: that child works in its own workspace and clones the repo named by `repo`.' }, { name: 'repo', description: 'The repository this run was started for, as scan-registry.yaml names it (owner/name). Set by a sweep fanning out over repositories; leave blank when you are pointing the run at a checkout yourself.' }, { name: 'branch', description: 'The branch to scan. Leave it blank for the product\'s development branch from the registry (branches.bug, usually develop). The run reads it in a worktree of its own, never the shared clone.' }],
    steps: [
      ...
      { agentTemplateId: 'sdlc-decision-gate', id: 'decision-gate', label: 'Decision Gate', next: ['create-jira-auto-approved', 'tell-reviewers'], monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-auto-approved', label: 'Create Jira (Auto-Approved)', next: ['dispatch-auto-approved-to-runbook-a-b'], jira: { action: 'create', source: 'approved-drafts.json' }, runWhen: { artifact: 'approved-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the e2e scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-auto-approved-to-runbook-a-b', label: 'Dispatch Auto-Approved to Runbook A/B', next: [], runWhen: { artifact: 'approved-drafts.json' }, triggerWorkflow: { source: 'approved-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-escalated-to-runbook-a-b', label: 'Dispatch Escalated to Runbook A/B', next: [], runWhen: { artifact: 'escalated-drafts.json' }, triggerWorkflow: { source: 'escalated-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
    ],
  },
  {
    ...
    description: 'Scans a repository for UI bugs (accessibility WCAG 2.1 AA, responsive layout, visual consistency, interactive elements, console errors), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    ...
    steps: [
      ...
      { agentTemplateId: 'sdlc-decision-gate', id: 'decision-gate', label: 'Decision Gate', next: ['create-jira-auto-approved', 'tell-reviewers'], monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-auto-approved', label: 'Create Jira (Auto-Approved)', next: ['dispatch-auto-approved-to-runbook-a-b'], jira: { action: 'create', source: 'approved-drafts.json' }, runWhen: { artifact: 'approved-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the ui scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-auto-approved-to-runbook-a-b', label: 'Dispatch Auto-Approved to Runbook A/B', next: [], runWhen: { artifact: 'approved-drafts.json' }, triggerWorkflow: { source: 'approved-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-escalated-to-runbook-a-b', label: 'Dispatch Escalated to Runbook A/B', next: [], runWhen: { artifact: 'escalated-drafts.json' }, triggerWorkflow: { source: 'escalated-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
    ],
  },
  {
    ...
    description: 'Scans a repository for performance issues (N+1 queries, algorithmic complexity, memory/resource patterns, frontend performance, config/infra), triages findings, files clear-cut and escalated tickets in Jira without a human review, and dispatches to Runbook A or B.',
    icon: 'i-lucide-gauge',
    parameters: [{ name: 'projectDir', description: 'The repository checkout to scan. Leave it blank on a run started by a sweep: that child works in its own workspace and clones the repo named by `repo`.' }, { name: 'repo', description: 'The repository this run was started for, as scan-registry.yaml names it (owner/name). Set by a sweep fanning out over repositories; leave blank when you are pointing the run at a checkout yourself.' }, { name: 'branch', description: 'The branch to scan. Leave it blank for the product\'s development branch from the registry (branches.bug, usually develop). The run reads it in a worktree of its own, never the shared clone.' }],
    steps: [
      ...
      { agentTemplateId: 'sdlc-decision-gate', id: 'decision-gate', label: 'Decision Gate', next: ['create-jira-auto-approved', 'tell-reviewers'], monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-auto-approved', label: 'Create Jira (Auto-Approved)', next: ['dispatch-auto-approved-to-runbook-a-b'], jira: { action: 'create', source: 'approved-drafts.json' }, runWhen: { artifact: 'approved-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-notifier', id: 'tell-reviewers', label: 'Tell reviewers', next: ['create-jira-escalated-after-review'], runWhen: { artifact: 'escalated-drafts.json' }, notify: { channel: 'workflow updates', message: '{count} escalated drafts from the performance scan are being filed without review.' } },
      { agentTemplateId: 'sdlc-jira-creator', id: 'create-jira-escalated-after-review', label: 'Create Jira (Escalated)', next: ['dispatch-escalated-to-runbook-a-b'], jira: { action: 'create', source: 'escalated-drafts.json' }, runWhen: { artifact: 'escalated-drafts.json' }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-auto-approved-to-runbook-a-b', label: 'Dispatch Auto-Approved to Runbook A/B', next: [], runWhen: { artifact: 'approved-drafts.json' }, triggerWorkflow: { source: 'approved-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
      { agentTemplateId: 'sdlc-auto-dispatcher', id: 'dispatch-escalated-to-runbook-a-b', label: 'Dispatch Escalated to Runbook A/B', next: [], runWhen: { artifact: 'escalated-drafts.json' }, triggerWorkflow: { source: 'escalated-drafts.json', routeBy: 'work_type', routes: { bug: 'runbook-a-ticket-to-evidence-backed-pr', security: 'runbook-a-ticket-to-evidence-backed-pr', infra: 'runbook-a-ticket-to-evidence-backed-pr', feature: 'runbook-b-feature-request-to-evidence-backed-pr', change_request: 'runbook-b-feature-request-to-evidence-backed-pr' } }, monitorSlug: 'sdlc-step-monitor' },
    ],
