...
{
  // Signature follows agentCaller.ts: (slug, input, projectDir, signal, env, onProgress).
  // onProgress moved to sixth when the abort signal and per-user env were added.
  runner.setAgentCaller(async (_agentSlug, _input, _projectDir, _signal, _env, onProgress) => {
